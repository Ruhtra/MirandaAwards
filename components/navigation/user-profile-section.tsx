    ...
    <>
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button variant="ghost" className="w-full justify-between gap-2 h-auto py-2 px-3 hover:bg-secondary/50">
          ...
          <DropdownMenuLabel className="font-normal">
            <div className="flex items-center gap-2.5">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-muted-foreground truncate mb-1">{currentUser.email}</p>
                <Badge variant={getRoleVariant(currentUser.role)} className="text-[10px] h-4 px-1.5">
